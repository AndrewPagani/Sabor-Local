...
import 'cadastrar_novo_endereco_comp_model.dart';
export 'cadastrar_novo_endereco_comp_model.dart';

class CadastrarNovoEnderecoCompWidget extends StatefulWidget {
  const CadastrarNovoEnderecoCompWidget({super.key});

  @override
  State<CadastrarNovoEnderecoCompWidget> createState() =>
      _CadastrarNovoEnderecoCompWidgetState();
}

class _CadastrarNovoEnderecoCompWidgetState
    extends State<CadastrarNovoEnderecoCompWidget> {
  late CadastrarNovoEnderecoCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrarNovoEnderecoCompModel());
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (_model.cepTextController.text == '') {
                        ...
                        // API ValidaCEP
                        _model.apiResultyp5 = await ValidacepCall.call(
                        ...
                        if (getJsonField(
                          ...
                          // Preenche o Bairro
                          safeSetState(() {
                            _model.bairroTextController?.text = getJsonField(
                              (_model.apiResultyp5?.jsonBody ?? ''),
                              r'''$.bairro''',
                            ).toString();
                          });
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(119.0, 10.0, 119.0, 0.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        var _shouldSetState = false;
                        if ((_model.logradouroTextController.text == '') ||
                          ...
                          FFAppState().enderecoState = getJsonField(
                            (_model.apiConteinerendereco?.jsonBody ?? ''),
