...
import 'cardapio_copy_model.dart';
export 'cardapio_copy_model.dart';

class CardapioCopyWidget extends StatefulWidget {
  const CardapioCopyWidget({super.key});

  static String routeName = 'CardapioCopy';
  static String routePath = '/cardapioCopy';

  @override
  State<CardapioCopyWidget> createState() => _CardapioCopyWidgetState();
}

class _CardapioCopyWidgetState extends State<CardapioCopyWidget> {
  late CardapioCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardapioCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final cardapioCopyBuscaCardapioResponse = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: Autocomplete<String>(
                                        ...
                                        optionsBuilder: (textEditingValue) {
                                          ...
                                          return functions
                                              .barraDePesquisa(
                                                  cardapioCopyBuscaCardapioResponse
                                                      .jsonBody,
                                                  '')
                                              .map((e) => e.toString())
                                              .toList()
                                        ...
                                        optionsViewBuilder:
                                          ...
                                          return AutocompleteOptionsList(
                                            textFieldKey: _model.pesquisaKey,
                                            textController:
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: 'https://i.imgur.com/1OSYa6l.png',
                                    width: 101.7,
                                    height: 233.0,
                                    fit: BoxFit.fill,
                                  ),
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fadeOutDuration:
                                        Duration(milliseconds: 500),
                                    imageUrl: 'https://i.imgur.com/ygwM12l.png',
                                    width: 101.7,
                                    height: 233.0,
                                    fit: BoxFit.fitHeight,
                                  ),
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fadeOutDuration:
                                        Duration(milliseconds: 500),
                                    imageUrl: 'https://i.imgur.com/1H47EzX.png',
                                    width: 101.7,
                                    height: 233.0,
                                    fit: BoxFit.fitHeight,
                                  ),
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final pratoprincipal = functions
                                        .barraDePesquisa(
                                            getJsonField(
                                              cardapioCopyBuscaCardapioResponse
                                                  .jsonBody,
                                    ...
                                    return ListView.builder(
                                      ...
                                      scrollDirection: Axis.horizontal,
                                      itemCount: pratoprincipal.length,
                                      itemBuilder:
                                          (context, pratoprincipalIndex) {
                                        final pratoprincipalItem =
                                            pratoprincipal[pratoprincipalIndex];
                                        return Builder(
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(CardapioCopyWidget.routeName);
                                },
                                child: Icon(
                                  Icons.home,
                                  color: Colors.white,
