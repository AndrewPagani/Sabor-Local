...
class PedidoRealizadoWidget extends StatefulWidget {
  const PedidoRealizadoWidget({
    super.key,
    required this.momentoClique,
  });

  final DateTime? momentoClique;

  static String routeName = 'PedidoRealizado';
  static String routePath = '/pedidoRealizado';
                  ...
                  Row(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/ChatGPT_Image_25_de_mai._de_2026__13_41_52-removebg-preview.png',
                          width: 222.3,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      dateTimeFormat(
                                          "dd/MM/yyyy", widget.momentoClique),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
